...
<div class="vh-100 d-flex justify-content-center align-items-center">
    <div class="card col-md-4 bg-white shadow-md p-5">
        ...
        <div class="text-center">
            <h1>Thank You !</h1>
            <p>Kami sangat menghargai partisipasi Anda dalam proses pemilihan. Terima kasih atas kontribusinya!</p>
            <a href="/logout" class="btn btn-outline-success">Keluar</a>
        </div>
    </div>
    @endsection